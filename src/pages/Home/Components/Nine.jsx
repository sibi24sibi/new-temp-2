...
const Nine = () => {
  ...
  const currentRowsRight = rightTableData.slice(
    indexOfFirstRowRight,
    indexOfLastRowRight
  );
  const totalPagesRight = Math.ceil(rightTableData.length / rowsPerPageRight);

  const handleNextPageRight = () => {
    if (currentPageRight < totalPagesRight)
      setCurrentPageRight(currentPageRight + 1);
  };
  ...
  return (
    <div className="flex gap-8 p-6 flex-col md:flex-row font-sans h-max-content">
      ...
      <div className="w-full md:w-[50%] border-2 border-gray-300 rounded-lg h-max-content p-6 shadow-lg space-y-6">
        {/* User Input Bubble */}
        <DashboardWithUser data="Generate me a table of sales ranking of all products. Also add pagination" />
                ...
                {/* <div className="flex flex-wrap items-center gap-2"> */}
                  ...
                  <div className="flex items-center border rounded p-2">
                    <input
                      ...
                      className="text-sm w-full max-w-[140px] outline-none"
                    />
      ...
      <div className="w-full md:w-[50%] border-2 border-gray-300 rounded-lg h-max-content shadow-lg p-6 flex flex-col md:gap-6 md:pt-8">
        ...
        <div className="mb-8 flex flex-col gap-6">
          ...
          <div className=" rounded-lg p-4 shadow-md bg-green-500 bg-opacity-70">
            ...
            <div className="flex flex-row items-center space-x-4 mb-6">
              ...
              <div className="flex justify-between items-center mt-6">
                ...
                <span>
                  Page {currentPageRight} of {totalPagesRight}
                </span>
                <button
                  className={`px-4 py-2 bg-gray-200 rounded ${
                    currentPageRight === totalPagesRight && "opacity-50"
                  }`}
