...
const Sixth = () => {
    return (
        <div className="min-h-screen md:min-h-0 flex flex-col md:flex-row gap-8 p-6 font-sans">
            ...
            <div className="w-full md:w-[50%] md:flex md:flex-col md:min-h-0 border-2 border-gray-300 rounded-lg shadow-lg p-6 space-y-auto">
                ...
                <div className="md:my-auto">
                    <h2 className="text-lg font-bold mb-4">SQL Query Generation</h2>
                    <div className="border-2 border-gray-200 rounded-lg p-4 mb-6 shadow-md bg-gray-900">
                        <pre className="text-sm font-mono text-gray-100 h-[150px] overflow-auto">
                            <code className="language-sql">
                                <span className="text-blue-400">SELECT</span>
                                {'\n'}    <span className="text-blue-400">CASE</span> Name
                                {'\n'}        <span className="text-blue-400">WHEN</span> <span className="text-green-400">'max'</span> <span className="text-blue-400">THEN</span> <span className="text-green-400">'Name is max'</span>
                                {'\n'}        <span className="text-blue-400">WHEN</span> <span className="text-green-400">'jack'</span> <span className="text-blue-400">THEN</span> <span className="text-green-400">'Name is jack'</span>
                                {'\n'}        <span className="text-blue-400">WHEN</span> <span className="text-green-400">'alice'</span> <span className="text-blue-400">THEN</span> <span className="text-green-400">'Name is alice'</span>
                                {'\n'}        <span className="text-blue-400">ELSE</span> <span className="text-green-400">'You have selected another user'</span>
                                {'\n'}    <span className="text-blue-400">END</span> <span className="text-blue-400">AS</span> Result,
                                {'\n'}    Age,
                                {'\n'}    <span className="text-blue-400">CASE</span>
                                {'\n'}        <span className="text-blue-400">WHEN</span> Age <span className="text-blue-400">&gt;</span> <span className="text-purple-400">30</span> <span className="text-blue-400">THEN</span> <span className="text-green-400">'Senior'</span>
                                {'\n'}        <span className="text-blue-400">WHEN</span> Age <span className="text-blue-400">BETWEEN</span> <span className="text-purple-400">20</span> <span className="text-blue-400">AND</span> <span className="text-purple-400">30</span> <span className="text-blue-400">THEN</span> <span className="text-green-400">'Mid-Level'</span>
                                {'\n'}        <span className="text-blue-400">ELSE</span> <span className="text-green-400">'Junior'</span>
                                {'\n'}    <span className="text-blue-400">END</span> <span className="text-blue-400">AS</span> AgeGroup
                                {'\n'}<span className="text-blue-400">FROM</span> TableName
                                {'\n'}<span className="text-blue-400">WHERE</span> Status <span className="text-blue-400">=</span> <span className="text-green-400">'active'</span>
                                {'\n'}<span className="text-blue-400">ORDER BY</span> Name <span className="text-blue-400">ASC</span>;
                            </code>
                        </pre>
                    </div>
                </div>
