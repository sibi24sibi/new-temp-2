...
const Seventh = () => {
    return (
        <div className="flex gap-7 p-6 flex-col md:flex-row font-sans h-max-content">
            {/* Left Section - Main Content */}
            {/* Left Section - Main Content */}
            <div className="w-full md:w-[49%] border-2 border-gray-300 rounded-lg h-max-content p-6 shadow-lg space-y-6">
                {/* User Input Bubble */}
            ...
            <div className="w-full md:w-[51%]  md:flex md:flex-col md:justify-between md:min-h-0 border-2 border-gray-300 rounded-lg shadow-lg p-6 space-y-6">
                {/* User Input Bubble */}
