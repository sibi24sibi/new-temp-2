  ...
  return (
    <div className="docs-content-scrollbar ml-[80px] w-[calc(100vw-80px)] md:w-full md:mx-auto h-[calc(100vh-68px)] overflow-y-auto">
      <div className="md:w-[60%] flex flex-col md:mx-auto items-start p-6 pb-12">
        <h2 className="text-3xl font-bold text-[#4cba8b] mb-6 text-center">Data Sources</h2>
        ...
        <div className="flex items-start mb-6">
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-700 mt-2">
              ...
              <li>
                Connect DBs (MySQL, MongoDB, or Snowflakes. Only tables/structured data are allowed. Use tables for MySQL
                and use Collections for Snowflakes)
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex items-start mb-6">
          ...
          <div>
            ...
            <p className="text-gray-700">Click on Preview Data on Home Screen</p>
          </div>
        </div>
      </div>
    </div>
