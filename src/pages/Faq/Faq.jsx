...
const Faq = () => {
    ...
    return (
        <div className="h-[calc(100vh-64px)] flex flex-col lg:flex-row mt-[64px] relative">
            {/* Sidebar */}
            <div
            ...
            >
                <h2 className={`font-bold text-2xl mt-4 ml-8 z-10  ${!isMenuVisible ? " hidden" : "block"}`}>FAQ</h2>
            ...
            {/* Main Content */}
            <div className={`transition-all duration-500 w-full p-6 ${isMenuVisible ? "ml-64" : "ml-20"}`}>
