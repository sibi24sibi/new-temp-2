    ...
    return (
        <div className="max-w-[1200px] md:min-w-[60%] mx-auto p-6 relative">
            ...
            <div className="absolute top-72 left-60 transform scale-x-[-1] md:block hidden text-center">
                ...
                <div className="bg-gray-800 text-white translate-x-12 translate-y-3 text-xs px-2 py-1 mt-1 rounded-md shadow-md inline-block transform scale-x-[-1]">
                    Pointer 3
                </div>
            </div>
            ...
            <div className="absolute top-72 right-72 md:block hidden text-center">
                ...
                <div className="bg-gray-800 text-white text-xs px-2 py-1 mt-1 rounded-md shadow-md inline-block">
                    Pointer 4
                </div>
            </div>
