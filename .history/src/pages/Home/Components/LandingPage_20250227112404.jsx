...
const LandingPage = () => {
    ...
    return (
        <div className="max-w-[1200px] md:min-w-[60%] mx-auto p-6 ">
            ...
            <img src={pointer1} alt="pointer1" className="w-10 mx-auto absolute top-36 right-60 md:block hidden" />
            <img src={pointer1} alt="pointer1" className="w-10 mx-auto absolute top-36 left-64 transform scale-x-[-1]  md:block hidden" />
            <img src={pointer2} alt="pointer1" className="w-10 mx-auto absolute top-72 left-60  transform scale-x-[-1]  md:block hidden" />
            <img src={pointer3} alt="pointer1" className="w-10 mx-auto absolute top-72 right-72  md:block hidden " />
            <div className="md:text-center mb-8 my-10">
                <h1 className="md:text-6xl text-3xl  font-bold mb-4 md:mx-36">Generative BI Dashboard Development Tool</h1>
