            ...
            <div className="overflow-hidden" ref={emblaRef}>
                <div className="flex space-x-5">
                    {statsData.map((stat) => {
                        ...
                        return (
                            <div key={stat.id} className="bg-white  md:p-6 flex flex-col gap-4   md:min-w-[400px]">
                                        ...
                                        {firstSlice.map((item, index) => (
                                            ...
                                            >
                                                {typeof item.icon === "string" ? (
                                                    <img src={item.icon} alt={item.name} className="w-10 h-10 opacity-50 text-base" />
                                                ) : (
                                                    <item.icon className="w-10 h-10 opacity-50  text-base" />
                                                )}
