                                ...
                                <div className="relative flex justify-center overflow-hidden h-48  rounded-md p-4">
                                    ...
                                    <div className="flex flex-col w-full space-y-3 animate-marquee">
                                        {firstSlice.map((item, index) => (
                                            <div key={index} className="flex  flex-col bg-green-200 items-center justify-center gap-2  shadow-md rounded-md p-3 w-24">
                                    ...
                                    <div className="flex flex-col w-full space-y-3 animate-marquee-reverse">
                                        {secondSlice.map((item, index) => (
                                            <div key={index} className="flex flex-col items-center justify-center gap-2 bg-white bg-green-200 shadow-md rounded-md p-3 w-24">
                                                {typeof item.icon === "string" ? (
                                                    <img src={item.icon} alt={item.name} className="w-10 h-10" />
                                                ) : (
                                                    <item.icon className="w-10 h-10" />
                                    ...
                                    <div className="flex flex-col w-full space-y-3 animate-marquee">
                                        {thirdSlice.map((item, index) => (
                                            <div key={index} className="flex flex-col items-center justify-center gap-2 bg-green-200  shadow-md rounded-md p-3 w-24">
                                                {typeof item.icon === "string" ? (
                                                    <img src={item.icon} alt={item.name} className="w-10 h-10" />
                                                ) : (
                                                    <item.icon className="w-10 h-10" />
