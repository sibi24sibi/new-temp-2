    ...
    return (
        <div className="relative bg-gray-50 py-4 rounded-lg shadow-md overflow-hidden">
            ...
            <div className="relative">
                {/* Left fade effect */}
                <div className="absolute left-0 top-0 h-full w-16 bg-gradient-to-r from-gray-50 via-gray-50 to-transparent z-10"></div>

                {/* Right fade effect */}
                <div className="absolute right-0 top-0 h-full w-16 bg-gradient-to-l from-gray-50 via-gray-50 to-transparent z-10"></div>
                    ...
                    <div className="flex items-center h-20">
                        {[...companyImages, ...companyImages].map((logo, index) => (
                            <img
                                ...
                                className="h-16 w-auto mx-16 opacity-90 hover:opacity-100 transition-transform transform hover:scale-110 duration-300 ease-in-out"
                            />
                        ))}
                    </div>
                </Marquee>
