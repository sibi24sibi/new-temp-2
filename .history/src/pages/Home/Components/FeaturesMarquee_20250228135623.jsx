            ...
            <div className="overflow-hidden" ref={emblaRef}>
                <div className="flex space-x-8  md:ml-8">
                    {statsData.map((stat) => {
                        ...
                        return (
                            <div key={stat.id} className="bg-white  p-6 flex flex-col gap-4  w-full md:min-w-96">
                                ...
                                <div className="relative flex justify-center overflow-hidden h-48 rounded-md p-4">
                                    ...
                                    <div className="flex flex-col w-full space-y-3 animate-marquee">
                                        {firstSlice.map((item, index) => (
                                            <div
                                                key={item.id}
                                                className={`flex flex-col items-center justify-center mx-5  gap-2 shadow-md rounded-md p-3 w-24 ${index % 2 === 0 ? 'bg-green-100' : 'bg-green-200'}`}
                                            >
