  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/smartcard-ai" element={<Smartcardai />} />{" "}
        {/* New route */}
        <Route path="/features" element={<Features />}>
          <Route index element={<Navigate to="insight-generation" replace />} />{" "}
          {/* Redirect to the first guideline */}
